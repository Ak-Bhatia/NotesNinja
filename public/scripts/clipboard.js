var share1 = document.querySelector('.share1');
share1.addEventListener("click",function () {
    ...
    clipboard.classList.toggle("d-none");
    window.alert("url copied to the clipboard.Now you can share this link");
    window.location.href = 'https://twitter.com/login?lang=en';
});

var share2 = document.querySelector('.share2');
...
function verify() {
     var temp = confirm("Please note username and secret code before pressing ok");
    if(temp){
        return true;
    }else{
        return false;
...
purchase.addEventListener("click",function () {
   ...
   stores.classList.toggle("d-none"); 
